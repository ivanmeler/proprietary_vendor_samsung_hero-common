...
PRODUCT_COPY_FILES += \
  ...
  vendor/samsung/hero-common/proprietary/vendor/lib/libatparser.so:system/vendor/lib/libatparser.so \
  vendor/samsung/hero-common/proprietary/vendor/lib/libfactoryutil.so:system/vendor/lib/libfactoryutil.so \
  vendor/samsung/hero-common/proprietary/vendor/lib/libomission_avoidance.so:system/vendor/lib/libomission_avoidance.so \
  vendor/samsung/hero-common/proprietary/vendor/lib64/libatparser.so:system/vendor/lib64/libatparser.so \
  vendor/samsung/hero-common/proprietary/vendor/lib64/libfactoryutil.so:system/vendor/lib64/libfactoryutil.so \
  vendor/samsung/hero-common/proprietary/vendor/lib64/libomission_avoidance.so:system/vendor/lib64/libomission_avoidance.so \
